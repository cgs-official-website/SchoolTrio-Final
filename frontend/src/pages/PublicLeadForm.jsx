...
export default function PublicLeadForm() {
  ...
  useEffect(() => {
    const fetchFormSchema = async () => {
      try {
        ...
        const res = await admissionsApi.getPublicLeadForm(schoolId, formId);
        const data = res?.data;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Submit to PostgreSQL REST backend
      await admissionsApi.submitPublicLead(schoolId, formId, {
        data: formData
      });
      ...
      console.error(err);
      const errMsg = err.response?.data?.message || err.message || 'Error submitting form. Please try again.';
