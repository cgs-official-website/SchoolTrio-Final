...
import { LuCreditCard as CreditCard, LuPlus as Plus, LuCircleCheck as CheckCircle2, LuSearch as Search, LuX as X, LuReceipt as Receipt, LuTrendingUp as TrendingUp, LuTriangleAlert as AlertTriangle, LuFilter as Filter } from 'react-icons/lu';
...
export default function FeeManagement() {
  ...
  const loadInitialData = useCallback(async () => {
    setLoading(true);
    try {
      const [classesRes, periodsRes, invoicesRes, statsRes] = await Promise.all([
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      if (invoiceCount === 0) {
        ...
        toast.success(`Fee assigned successfully! Generated ${invoiceCount} invoices.`);
      }
