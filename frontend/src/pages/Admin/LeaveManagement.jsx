                        ...
                        <div className="flex justify-between items-start mb-4">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <p className="text-[10px] text-slate-400 dark:text-slate-300 mt-1 font-semibold">Submitted: {leave.submittedAt ? new Date(leave.submittedAt).toLocaleDateString('en-GB') : 'N/A'}</p>
                            </div>
                          </div>
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar flex-1 space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-slate-50 dark:bg-slate-800 p-4 rounded-2xl border border-slate-100 dark:border-slate-800">
                  ...
                  <p className="text-sm font-bold text-slate-700 dark:text-slate-200 mt-0.5">{selectedLeave.submittedAt ? new Date(selectedLeave.submittedAt).toLocaleDateString('en-GB') : 'N/A'}</p>
                </div>
              </div>
