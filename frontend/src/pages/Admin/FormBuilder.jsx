...
import { getSidebarSettings, updateSidebarSettings } from '../../api/settings';
...
export default function FormBuilder() {
  ...
  const handleImportSchema = async (moduleId) => {
    ...
    try {
      ...
      try {
        const res = await getFormSchema(moduleId);
        const data = res?.data || res;
        ...
        // Fallback for core modules that don't have a saved schema in PostgreSQL yet
      }
