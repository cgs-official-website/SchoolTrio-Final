...
export default function LeaveRequests() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let docInfo = null;
      if (selectedFile) {
        const storagePath = `schools/${schoolId}/leaves/${currentUser?.uid || 'staff'}_${Date.now()}_${selectedFile.name}`;
      ...
      const payload = {
        ...
        customLeaveType: formData.leaveType === 'others' ? formData.customType : undefined,
