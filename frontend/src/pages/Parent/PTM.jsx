...
export default function PTM() {
  ...
  const fetchMeetings = useCallback(async (targetStudentId) => {
    if (!targetStudentId) {
      setMeetings([]);
      setLoading(false);
      return;
    ...
    try {
      setLoading(true);
      const res = await ptmApi.getStudentAppointments(targetStudentId);
                ...
                <div className="flex justify-between items-start mb-4">
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <h3 className="text-base font-bold text-slate-900 dark:text-white leading-tight truncate">{meeting.teacherName || 'Class Teacher'}</h3>
